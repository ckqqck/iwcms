		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                ?>
						...
						<form role="form" action="<?php echo base_url() ?>manage/vote/add" method="post" id="addvote" role="form">
						<div class="row">
							<div class="col-md-5 grid_box1">
								<div class="form-group"> <label for="ftitle">标题</label> 
								<input type="text" class="form-control" id="title" placeholder="" name="title" required lay-verify="required" > </div>
					...
					type="text" class="form-control"  required lay-verify="required" id="date"></div>
							</div>
							<div class="col-md-7">
					...
					type="text" class="form-control"  required lay-verify="required" id="date"></div>									
						...
						<textarea cols="40" rows="10" name="info" id="info" required lay-verify="required" verify="info"></textarea>
						<div class="clearfix"> </div>
						<label for="role" class="th">投票说明</label>
						<textarea cols="40" rows="3" name="infosm" id="infosm" lay-verify="contact" verify="infosm"></textarea>
						<div class="clearfix"> </div>
						<label for="role"  class="th">奖品说明</label>
						<textarea cols="40" rows="3" name="infojp" id="infojp" lay-verify="contact" verify="infojp"></textarea>
						
								<div class="form-group"> <label for="gender"></label> 
										<div class="radio">
											<label style="padding-right: 5px">
											  <input type="radio" name="cknums" value="0" checked="checked">
											 单人投票
											</label>
											<label  style="padding-right: 40px">
											<input type="radio" name="cknums" value="1">
											多人投票
											</label>
											<label style="padding-right: 5px">
											  <input type="radio" name="votelimit" value="0" checked="checked">
											 每天投一票
											</label>
											<label>
											<input type="radio" name="votelimit"value="1">
											每小时投一票
											</label>
										</div>
								</div>
								<input type="hidden" id="goods_pic" name="imgurl" type="text">
