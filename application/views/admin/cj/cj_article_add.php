						...
						<div id="container" class="container_l">
							...
							<div id="content_left">
								<ul class="tabContent" id="lists">
									<form action="<?php echo base_url();?>admin/cj/article/insert"
									...
									<div class="rfm">
											<table class="table_message_center msg">
												<tbody>
													<tr>
														...
														<td><ul class="nofloat">
																<li class=""><input type="radio" class="radio"
																	id="is_img1" name="is_img" value="0"><label
																	for="is_img1">是</label></li>
																<li class=""><input type="radio" class="radio"
																	id="is_img2" name="is_img" value="1" 'checked="checked"><label
													...
													<tr id="style_image" style="display: none;">
														<th>单条网址输入：</th>
														<td><textarea rows="6" name="b_listconment"
																id="listconment" cols="50" class="tarea"
																onblur="uper(this.value);return false;"></textarea><span
															style="color: red">*</span>一行一个</td>
														<td width="20%"></td>
													</tr>
													<tr id="style_text" style="display: none;">
														<th>导入网址：</th>
														<td><input type="text" class="px p_fre" size="70"
															name="c_wwwsss"><span style="color: red">*</span>后缀.txt</td>
														<td width="20%"></td>
													</tr>
													<tr id="style_code">
														<th>多条网址规则：</th>
														<td>地址格式：<input type="text" class="px p_fre" size="70"
															name="a_www" id="www"
															onblur="upperCase(this.id);return false;"
															value="<?php echo set_value('www'); ?>" /><a
															href="javascript:void(0);"
															onclick="insertAtCursor('www', '(*)');"><span
																style="color: red"> (*) </span></a><br> <br> <input
															type="radio" class="radio" id="optype_dengcha"
															name="a_bi" value="1" onclick="upperCase();"
															<?php echo set_radio('a_bi', '1' , TRUE); ?>><label
															for="optype_dengcha">等差数列</label>：首项<input type="text"
															class="px p_fre" size="3" id="chaone" name="a_chaone"
															value="1" /> 项数<input type="text" class="px p_fre"
															size="3" id="chanum" name="a_chanum" value="5" /> 公差<input
															type="text" class="px p_fre" size="3" id="chacommon"
															name="a_chacommon" value="1" />&nbsp;&nbsp;<input
															id="click_1" class="pc" type="checkbox"
															name="a_chacheckbox" value="1"
															<?php echo set_radio('a_chacheckbox', '1'); ?>><label
															class="lb" for="click_1">倒序</label><br> <br> <input
															type="radio" class="radio" id="optype_1" name="a_bi"
															value="2" onclick="upperCase();"
															<?php echo set_radio('a_bi', '2'); ?>><label
															for="optype_1">等比数列</label>：首项<input type="text"
															class="px p_fre" size="3" id="bione" name="a_bione"
															value="1" /> 项数<input type="text" class="px p_fre"
															size="3" id="binum" name="a_binum" value="5" /> 公比<input
															type="text" class="px p_fre" size="3" id="bicommon"
															name="a_bicommon" value="2" />&nbsp;&nbsp;<input
															id="click_2" class="pc" type="checkbox"
															name="a_bicheckbox" value="1"
															<?php echo set_radio('a_bicheckbox', '1'); ?>><label
															class="lb" for="click_2">倒序</label></td>
														<td width="20%"></td>
													</tr>
													<tr>
														<th>内容页网址获取：</th>
																...
																<tbody>
																	<tr>
																		<td><input type="radio" class="radio" name="dom"
																			id="uid4" value="0" checked="checked"
																	...
																	<tr id="str_to_dom" style="display: none;">
																		<td><textarea rows="3" name="click_str"
																				id="click_str" cols="38" class="tarea"></textarea>
																		</td>
																	...
																	<tr id="dom_to_str">
																		<td>DOM标签 <textarea rows="2" name="click_dom"
																				id="listconment" cols="28" class="tarea"></textarea>
																		</td>
																		<td><p>div.class</p>
																			<p>div#id</p>
																			<p>div[!id]</p></td>
																	...
																	<tr>
																		<td>必须包含<textarea rows="2" name="click_bh"
																				id="listconment" cols="28" class="tarea"></textarea></td>
												...
												<tr>
													...
													<td colspan="2">
														<div class="opt">
															...
															<button class="pn" type="button" onclick="cj_wwwtest(); return false;" value="测试采集">
																<em>测试采集</em>
															</button>
														</div>
													</td>
								...
								<ul class="tabContent" id="conment">
									<form
										action="<?php echo base_url();?>admin/cj/article/insert_comment"
										method="post" accept-charset="utf-8">	
								<?php echo validation_errors(); ?>
									<div class="rfms">
												...
												<tbody>
													...
													<tr>
														...
														<td><textarea rows="3" name="db_title_str"
																id="db_title_str" cols="28" class="tarea">[title]</textarea></td>
														<td><a href="javascript:void(0);" onclick="insertAtCursor('db_title_str', '[title]');">  插入<span style="color: red"> [title] </span></a></td>
														<td><textarea rows="3" name="db_title_dom" id="listconment"
																cols="18" class="tarea"></textarea></td>
														<td><input id="db_title_dom_on" class="pc" type="checkbox" name="db_title_dom_on" checked="checked"><label class="lb" for="db_title_dom_on">DOM</label></td>
													</tr>
													<tr>
														<th>内容：[内容]</th>
														<td><textarea rows="3" name="db_comment_str"
																id="db_comment_str" cols="28" class="tarea">[comment]</textarea></td>
														<td><a href="javascript:void(0);" onclick="insertAtCursor('db_comment_str', '[comment]');">  插入<span style="color: red"> [comment] </span></a>
														<br><br>采集分页：<input id="db_page_1"
															class="pc" type="radio" name="page" value="1"
															 onclick="$('page_0').style.display = '';"><label
																class="lb" for="db_page_1" style="color: red">是</label>&nbsp;&nbsp;&nbsp;&nbsp;
															<input id="db_page_0"
															class="pc" type="radio" name="page" value="0" checked="checked" 
															onclick="$('page_0').style.display = 'none';"><label
																class="lb" for="db_page_0" style="color: red">否</label>				
														
														</td>
														<td><textarea rows="3" name="db_comment_dom" id="listconment"
																cols="18" class="tarea"></textarea></td>
														<td><input id="db_comment_dom_on" class="pc" type="checkbox" name="db_comment_dom_on" checked="checked"><label class="lb" for="db_comment_dom_on">DOM</label></td>
													</tr>
													<tr id="page_0" style="display: none;">
														<th>分页规则：</th>
														<td><table class="dom_to_str">
																<tbody>
																	<tr>
																		<td><input type="radio" class="radio" name="db_page_type"
																			id="page1" value="0" checked="checked"
																			onclick="$('page_to_dom').style.display = '';$('page_to_str').style.display = 'none';"><label
																			for="page1">dom采集</label>&nbsp;&nbsp;&nbsp;&nbsp;<input
																			type="radio" class="radio" name="db_page_type" id="page2"
																	...
																	<tr id="page_to_str" style="display: none;">																	
																		<td><textarea rows="3" name="db_page_str" id="page_str"
																				cols="38" class="tarea"></textarea></td>
																		<td><a href="javascript:void(0);"
																	...
																	<tr id="page_to_dom">
																		<td><textarea rows="3" name="db_page_dom"
																				id="listconment" cols="38" class="tarea"></textarea>
																		</td>
																		<td><p>div.class</p>
																			<p>div#id</p>
																			<p>div[!id]</p></td>
													...
													<tr>
														<th>时间：[时间]</th>
														<td><textarea rows="3" name="db_time_str"
																id="db_time_str" cols="28" class="tarea">[time]</textarea></td>
														<td><a href="javascript:void(0);" onclick="insertAtCursor('db_time_str', '[time]');">  插入<span style="color: red"> [time] </span></a></td>
														<td><textarea rows="3" name="db_time_dom" id="listconment"
																cols="18" class="tarea"></textarea></td>
														<td><input id="db_time_dom_on" class="pc" type="checkbox" name="db_time_dom_on" checked="checked"><label class="lb" for="db_time_dom_on">DOM</label></td>
													</tr>
													<tr>
														<th>出处：[出处]</th>
														<td><textarea rows="3" name="db_form_str"
																id="db_form_str" cols="28" class="tarea">[form]</textarea></td>
														<td><a href="javascript:void(0);" onclick="insertAtCursor('db_form_str', '[form]');">  插入<span style="color: red"> [form] </span></a></td>
													...
													<tr>
														...
														<td><textarea rows="3" name="db_author_str"
																id="db_author_str" cols="28" class="tarea">[author]</textarea></td>
														<td><a href="javascript:void(0);" onclick="insertAtCursor('db_author_str', '[author]');">  插入<span style="color: red"> [author] </span></a></td>
														<td><textarea rows="3" name="db_author_var"
																id="listconment" cols="18" class="tarea"></textarea></td>
														<td>自定义</td>
													</tr>
												</tbody>
											</table>
