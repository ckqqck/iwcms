			...
			<div class="main-page">
				...
				<ol class="breadcrumb">
					...
					<div class="form-grids widget-shadow">
						...
						<div class="form-body">
						<form role="form" action="<?php echo base_url() ?>manage/voteitem/add?aid=<?=$aid?>" method="post" id="updatevoteitem" role="form">
						<div class="form-group"> <label for="ftitle">姓名</label> 
								<input type="text" class="form-control" id="title" placeholder="" name="item" required lay-verify="required"> </div>
						<div class="form-group"> <label for="ftitle">排序</label> 
								<input type="text" class="form-control" id="title" placeholder="" name="rank" required lay-verify="required"> </div>
						<div class="form-group"> <label for="ftitle">电话</label> 
								<input type="text" class="form-control" id="title" placeholder="" name="tourl" required lay-verify="required"> </div>
						<div class="form-group">
							<ul class="pagination pagination-lg">
								<li><a href="javascript:;" aria-label="Previous"><span aria-hidden="true">-</span></a></li>
								<li><a href="javascript:;" style="padding: 0px;" ><input id="5" style="padding: 8px 6px" name="vcount"/></a></li>
						...
						<div class="form-group"> 
						<label>简介</label>
						<textarea cols="40" rows="10" name="intro" id="info" required lay-verify="required" verify="intro"></textarea>
						</div>
						<div class="clearfix"> </div>
								<input type="hidden" id="goods_pic" name="startpicurl" required lay-verify="required">
