<!--Calender-->
<link rel="stylesheet" href="<?php echo base_url(); ?>static/admin/css/clndr.css" type="text/css" />
<script src="<?php echo base_url(); ?>static/admin/js/underscore-min.js" type="text/javascript"></script>
<script src= "<?php echo base_url(); ?>static/admin/js/moment-2.2.1.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>static/admin/js/clndr.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>static/admin/js/site.js" type="text/javascript"></script>
<!--End Calender-->
		<!-- main content start-->
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<!--map js-->
						<link href="<?php echo base_url(); ?>static/admin/css/jqvmap.css" rel='stylesheet' type='text/css' />
						<script src="<?php echo base_url(); ?>static/admin/js/jquery.vmap.js"></script>
						<script src="<?php echo base_url(); ?>static/admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
						<script src="<?php echo base_url(); ?>static/admin/js/jquery.vmap.world.js" type="text/javascript"></script>
