		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                ?>
						...
						<form role="form" action="<?php echo base_url() ?>manage/article/add" method="post" id="addArticle" role="form">
						<div class="row">
							<div class="col-md-5 grid_box1">
								...
								<div class="form-group"> <label for="gender">推荐</label> 
										<div class="radio">
								...
								<div class="weui_cell_bd weui_cell_primary">
									<div class="weui_uploader">
										<div class="weui_uploader_bd">
											...
											<textarea rows="3" style="width:90.5%" name="summary" id="summary" lay-verify="contact" verify="summary"></textarea>
										</div>
									</div>
								</div>
							</div>
							<textarea cols="40" rows="10" name="body" id="body" lay-verify="contact" verify="body"></textarea>
